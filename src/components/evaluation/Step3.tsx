    ...
    <div className="space-y-6">
      ...
      <Card className="bg-white border-gray-200">
        <CardContent className="pt-6">
          <div className="mb-6">
            <h3 className="text-xl font-bold text-gray-900 mb-2">III. ADAPTABILITY</h3>
            ...
            <table className="w-full border-collapse border border-gray-300">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td className="border border-gray-300 px-4 py-3 text-center">
                    <ScoreDropdown
                      ...
                      onValueChange={(value) => updateDataAction({ adaptabilityScore1: value })}
                      placeholder="-- Select --"
                    />
                  </td>
                  <td className="border border-gray-300 px-4 py-3 text-center">
                    <div className={`px-2 py-1 rounded-md text-sm font-bold ${data.adaptabilityScore1 === '5' ? 'bg-green-100 text-green-800' :
                  ...
                  <td className="border border-gray-300 px-4 py-3">
                    <textarea
                      ...
                      onChange={(e) => updateDataAction({ adaptabilityComments1: e.target.value })}
                ...
                <tr>
                  ...
                  <td className="border border-gray-300 px-4 py-3 text-center">
                    <ScoreDropdown
                      ...
                      onValueChange={(value) => updateDataAction({ adaptabilityScore2: value })}
                      placeholder="-- Select --"
                    />
                  </td>
                  <td className="border border-gray-300 px-4 py-3 text-center">
                    <div className={`px-2 py-1 rounded-md text-sm font-bold ${data.adaptabilityScore2 === '5' ? 'bg-green-100 text-green-800' :
                  ...
                  <td className="border border-gray-300 px-4 py-3">
                    <textarea
                      ...
                      onChange={(e) => updateDataAction({ adaptabilityComments2: e.target.value })}
                      placeholder="Enter comments about this competency..."
                      className="w-full px-3 py-2 text-sm border border-gray-300 rounded-md bg-yellow-50 focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none"
                      rows={6}
                    />
                ...
                <tr>
                  ...
                  <td className="border border-gray-300 px-4 py-3 text-sm text-gray-700">
                    Remains focused and effective during periods of high stress or uncertainty. Completes tasks or meets deadlines when faced with unforeseen obstacles.
                  </td>
                  <td className="border border-gray-300 px-4 py-3 text-center">
                    <ScoreDropdown
                      value={data.adaptabilityScore3 || ''}
                      onValueChange={(value) => updateDataAction({ adaptabilityScore3: value })}
                      placeholder="-- Select --"
                    />
                  </td>
                  <td className="border border-gray-300 px-4 py-3 text-center">
                    <div className={`px-2 py-1 rounded-md text-sm font-bold ${data.adaptabilityScore3 === '5' ? 'bg-green-100 text-green-800' :
                  ...
                  <td className="border border-gray-300 px-4 py-3">
                    <textarea
                      ...
                      onChange={(e) => updateDataAction({ adaptabilityComments3: e.target.value })}
                      placeholder="Enter comments about this competency..."
                      className="w-full px-3 py-2 text-sm border border-gray-300 rounded-md bg-yellow-50 focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none"
                      rows={6}
                    />
      ...
      <Card className="bg-gradient-to-r from-blue-50 to-indigo-50 border-blue-200">
        <CardContent className="pt-6">
          <div className="text-center">
            <h3 className="text-xl font-bold text-gray-900 mb-4">Adaptability - Average Score</h3>
            <div className="flex justify-center items-center gap-6">
              ...
              <div className="text-left">
                ...
                <div className="space-y-1 text-sm">
                  <div>Openness to Change: <span className="font-semibold">{data.adaptabilityScore1 || 'Not rated'}</span></div>
                  <div>Flexibility in Job Role: <span className="font-semibold">{data.adaptabilityScore2 || 'Not rated'}</span></div>
                  <div>Resilience in the Face of Challenges: <span className="font-semibold">{data.adaptabilityScore3 || 'Not rated'}</span></div>
                </div>
              </div>
            </div>
            <div className="mt-4 text-xs text-gray-500">
              Average calculated from {[data.adaptabilityScore1, data.adaptabilityScore2, data.adaptabilityScore3].filter(score => score && score !== '').length} of 3 criteria
            </div>
          </div>
        </CardContent>
      </Card>
