    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent className="w-32 min-w-[128px] bg-white border-2 border-yellow-400">
        <DropdownMenuItem
          ...
          className="text-lg font-bold text-red-700 hover:bg-red-50 py-2 text-center justify-center cursor-pointer transition-all duration-200 hover:-translate-y-0.5 hover:shadow-sm active:translate-y-0 hover:text-white hover:bg-red-700"
        >
          1
        </DropdownMenuItem>
        <DropdownMenuItem
