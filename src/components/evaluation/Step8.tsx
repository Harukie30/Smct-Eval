  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger 
        ...
        disabled:opacity-50 border bg-background shadow-xs hover:bg-accent hover:text-accent-foreground cursor-pointer transition-all duration-200 hover:-translate-y-0.5 hover:shadow-sm active:translate-y-0 ${getScoreColor(value)}`}
      >
        {value || ''}
