        ...
        <DialogContent className="sm:max-w-md p-6">
          ...
          <DialogFooter className="pt-4">
            <Button 
              ...
              className="w-full bg-blue-600 hover:bg-blue-700 cursor-pointer transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md active:translate-y-0 text-white px-6 py-2"
            >
              I Understand
            </Button>
          </DialogFooter>
