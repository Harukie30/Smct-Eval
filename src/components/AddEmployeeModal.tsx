  ...
  return (
    <>
      <Dialog open={isOpen} onOpenChangeAction={onClose}>
        <DialogContent className={`max-w-3xl max-h-[90vh] overflow-y-auto p-6 bg-blue-100 ${dialogAnimationClass}`}>
          ...
          <DialogFooter className="flex justify-end space-x-3 pt-6 mt-6 border-t border-gray-200">
            ...
            <Button onClick={handleSave} className="bg-green-600 hover:bg-green-700 px-6" disabled={isSaving}>
              {isSaving ? (
          ...
          <div className="bg-white rounded-lg p-8 shadow-xl max-w-sm w-full mx-4">
            <div className="flex flex-col items-center space-y-4">
              ...
              <p className="text-sm text-gray-600 text-center">
                Please wait while we add the new employee. This may take a few moments.
              </p>
            </div>
          </div>
        </div>
