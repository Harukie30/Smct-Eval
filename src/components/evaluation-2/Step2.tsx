          ...
          <div className="overflow-x-auto">
            <table className="w-full border-collapse border border-gray-300">
              ...
              <tbody>
                ...
                <tr>
                  <td className="border border-gray-300 font-bold px-4 py-5 text-center text-sm text-black">
                ...
                <tr>
                  <td className="border border-gray-300 font-bold px-4 py-3 text-center text-sm text-black">
