  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center">
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Manager Performance Review Form</h2>
        <h3 className="text-lg font-semibold text-gray-700 mb-6">Manager Evaluation</h3>
      </div>
