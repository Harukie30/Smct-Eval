    ...
    <div className="space-y-6">
      ...
      <Card className="bg-white border-gray-200">
        <CardContent className="pt-6">
          <div className="mb-6">
            <h3 className="text-xl font-bold text-gray-900 mb-2">IV. TEAMWORK</h3>
                ...
                <tr>
                  ...
                  <td className="border border-gray-300 px-4 py-3 text-center">
                    <ScoreDropdown
                      ...
                      onValueChange={(value) => updateDataAction({ teamworkScore1: value })}
                      placeholder="-- Select --"
                    />
                  </td>
                  <td className="border border-gray-300 px-4 py-3 text-center">
                  ...
                  <td className="border border-gray-300 px-4 py-3">
                    <textarea
                      ...
                      onChange={(e) => updateDataAction({ teamworkComments1: e.target.value })}
                ...
                <tr>
                  ...
                  <td className="border border-gray-300 px-4 py-3 text-center">
                    <ScoreDropdown
                      ...
                      onValueChange={(value) => updateDataAction({ teamworkScore2: value })}
                      placeholder="-- Select --"
                    />
                  </td>
                  <td className="border border-gray-300 px-4 py-3 text-center">
                  ...
                  <td className="border border-gray-300 px-4 py-3">
                    <textarea
                      ...
                      onChange={(e) => updateDataAction({ teamworkComments2: e.target.value })}
                      placeholder="Enter comments about this competency..."
                ...
                <tr>
                  ...
                  <td className="border border-gray-300 px-4 py-3 text-center">
                    <ScoreDropdown
                      ...
                      onValueChange={(value) => updateDataAction({ teamworkScore3: value })}
                      placeholder="-- Select --"
                    />
                  </td>
                  <td className="border border-gray-300 px-4 py-3 text-center">
                  ...
                  <td className="border border-gray-300 px-4 py-3">
                    <textarea
                      ...
                      onChange={(e) => updateDataAction({ teamworkComments3: e.target.value })}
                      placeholder="Enter comments about this competency..."
                      className="w-full px-3 py-2 text-sm border border-gray-300 rounded-md bg-yellow-50 focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none min-h-[200px]"
                      rows={5}
                    />
      ...
      <Card className="bg-gradient-to-r from-blue-50 to-indigo-50 border-blue-200">
        <CardContent className="pt-6">
          <div className="text-center">
            <h3 className="text-xl font-bold text-gray-900 mb-4">Teamwork - Average Score</h3>
            <div className="flex justify-center items-center gap-6">
              ...
              <div className="text-left">
                ...
                <div className="space-y-1 text-sm">
                  <div>Active Participation in Team Activities: <span className="font-semibold">{data.teamworkScore1 || 'Not rated'}</span></div>
                  <div>Promotion of a Positive Team Culture: <span className="font-semibold">{data.teamworkScore2 || 'Not rated'}</span></div>
                  <div>Effective Communication: <span className="font-semibold">{data.teamworkScore3 || 'Not rated'}</span></div>
                </div>
              </div>
            </div>
            <div className="mt-4 text-xs text-gray-500">
              Average calculated from {[data.teamworkScore1, data.teamworkScore2, data.teamworkScore3].filter(score => score && score !== '').length} of 3 criteria
            </div>
          </div>
        </CardContent>
      </Card>
