...
export default function GoogleLoginModal({ 
  ...
  const [loginStep, setLoginStep] = useState<'select' | 'loading' | 'success'>('select');
    ...
    <>
      <style jsx>{`
        ...
        @keyframes continuousSlide {
          ...
          100% { transform: translateX(-50%); } /* Move by half the track width */
        }
        ...
        @keyframes slideWithPause {
          0% { transform: translateX(0%); }
          16.66% { transform: translateX(-50%); }
          83.33% { transform: translateX(-50%); }
          100% { transform: translateX(-50%); }
        }
        
        @keyframes centerSlide {
          0%, 16.66% { transform: translateX(0%); }
          83.33%, 100% { transform: translateX(-50%); }
        }
            ...
            <>
                          ...
                          <div className="w-full max-w-sm mx-auto">
                            <div className="relative flex items-center justify-center h-20 w-80 mx-auto overflow-hidden">
                              {images.map((image, index) => {
                                ...
                                const positions = [
                                  { x: -80, scale: 0.7, blur: 'blur-md', opacity: 0.6 }, // Left
                                  { x: 0, scale: 1.2, blur: 'blur-0', opacity: 1 },     // Center
                                  { x: 80, scale: 0.7, blur: 'blur-md', opacity: 0.6 }  // Right
                                ];
              ...
              <div className="text-center space-y-2">
                <p className="text-gray-600">
                  Sign in with your SMCT Google account to access the SMCT Evaluation System
                </p>
              ...
              <div className="w-full space-y-3">
                <Button
                  ...
                  disabled={isLoading}
                >
                  <img src="/chrome.png" alt="Google" className="w-5 h-5 mr-2" />
