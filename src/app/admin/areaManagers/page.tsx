            ...
            <Table>
              ...
              <TableBody>
                {loadingAreaManagers ? (
                  ...
                  areaManagersData.map((manager: Employee) => {
                    return (
                      <TableRow key={manager.id}>
                        ...
                        <TableCell className="py-4 text-center">
                          <div className="flex flex-wrap justify-center gap-2 w-full">
                            {manager.branches.map((branch: any) => (
                              <Badge
                                key={branch.id}
                      ...
                      onClick={async () => {
                        ...
                        await withErrorHandling(
                          async () => {
                            ...
                            const normalizedData = reloadedData.map(
                              (item: any) => ({
