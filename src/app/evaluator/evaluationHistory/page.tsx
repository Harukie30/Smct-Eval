        ...
        <CardHeader>
          <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
            ...
            <Button
              ...
              className="flex w-full items-center justify-center space-x-2 bg-blue-600 text-white hover:bg-blue-700 hover:text-white sm:w-auto"
            >
              <svg
                className="h-4 w-4"
                fill="none"
          ...
          <div className="mb-6">
            <div className="flex flex-wrap gap-2 items-center">
              ...
              {/* Probationary Button */}
              <Button
                variant={selectedQuarter === "Probationary" ? "default" : "outline"}
                size="sm"
                ...
                className={`text-xs font-medium transition-all duration-200 cursor-pointer ${
                  selectedQuarter === "Probationary"
                    ...
                    : `${getQuarterColor(
                        "Probationary"
                      )} border border-gray-300 hover:shadow-sm bg-white text-gray-700 cursor-pointer transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md active:translate-y-0`
                }`}
              >
                Probationary
              </Button>
              ...
              {/* Others Button */}
              <Button
                variant={selectedQuarter === "Others" ? "default" : "outline"}
                size="sm"
        ...
        <CardContent className="p-0">
          {isRefreshingOverview || isPaginate ? (
              ...
              <Table className="table-fixed min-w-[920px] w-full">
                <TableHeader className="sticky top-0 z-10 border-b bg-white shadow-sm [&_th]:text-xs [&_th]:font-semibold [&_th]:uppercase [&_th]:tracking-wide [&_th]:text-slate-600">
                  <TableRow>
                    ...
                    <TableHead className="w-1/6 pl-4">Date</TableHead>
            ...
            <NotFoundEmptyState
              ...
              description={`No performance reviews match "${debouncedSearchTerm}"`}
            />
          ) : (
            <>
