        ...
        <div className="space-y-6">
          ...
          <Card className="mt-8">
            ...
            <CardContent className="p-0">
              {submissions.length > 0 ? (
                <>
                  <div className="mx-4 max-h-[min(68vh,32rem)] overflow-y-auto overflow-x-auto rounded-lg border scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
                    {isPaginate ? (
