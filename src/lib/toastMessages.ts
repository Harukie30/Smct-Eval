...
export const toastMessages = {
  // Authentication
  login: {
    success: (username: string) => toast.success('Login Successful!', {
  ...
  // User Management
  user: {
    created: (username: string) => toast.success('User Created', {
      description: `${username} has been successfully created.`,
      duration: 3000,
    }),
    updated: (username: string) => toast.success('User Updated', {
      description: `${username}'s information has been updated.`,
      duration: 3000,
    }),
    deleted: (username: string) => toast.success('User Deleted', {
      description: `${username} has been removed from the system.`,
      duration: 3000,
    }),
    approved: (username: string) => toast.success('User Approved', {
      description: `${username} can now access the system.`,
      duration: 3000,
    }),
    rejected: (username: string) => toast.warning('User Rejected', {
      description: `${username}'s registration has been rejected.`,
      duration: 4000,
    }),
    reinstated: (username: string) => toast.success('User Reinstated', {
      description: `${username} has been reinstated and can access the system again.`,
      duration: 3000,
    }),
    suspended: (username: string) => toast.warning('User Suspended', {
      description: `${username} has been suspended and cannot access the system.`,
      duration: 4000,
    }),
    activated: (username: string) => toast.success('User Activated', {
      description: `${username}'s account has been activated.`,
      duration: 3000,
    }),
    deactivated: (username: string) => toast.warning('User Deactivated', {
  ...
  // Evaluation System
  evaluation: {
    saved: () => toast.success('Evaluation Saved', {
      description: 'Your evaluation has been saved successfully.',
      duration: 3000,
    }),
    submitted: () => toast.success('Evaluation Submitted', {
      description: 'Your evaluation has been submitted for review.',
      duration: 3000,
    }),
    completed: (employeeName: string) => toast.success('Evaluation Completed', {
      description: `Evaluation for ${employeeName} has been completed.`,
      duration: 3000,
    }),
    error: () => toast.error('Evaluation Error', {
  ...
  // File Operations
  file: {
    uploaded: (filename: string) => toast.success('File Uploaded', {
      description: `${filename} has been uploaded successfully.`,
      duration: 3000,
    }),
    uploadError: () => toast.error('Upload Failed', {
      description: 'Failed to upload file. Please try again.',
      duration: 4000,
    }),
    deleted: (filename: string) => toast.success('File Deleted', {
  ...
  // System Operations
  system: {
    dataRefreshed: () => toast.info('Data Refreshed', {
    ...
    exportStarted: () => toast.info('Export Started', {
      description: 'Your data export is being prepared...',
      duration: 3000,
    }),
    exportCompleted: () => toast.success('Export Completed', {
  ...
  form: {
    ...
    validationError: () => toast.error('Validation Error', {
      description: 'Please check all required fields.',
      duration: 4000,
    }),
    reset: () => toast.info('Form Reset', {
